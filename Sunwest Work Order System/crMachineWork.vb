...
Public Class crMachineWork
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sunwest_Work_Order_System.crMachineWork.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrMachineWork
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crMachineWork = New crMachineWork
        rpt.Site = Me.Site
        Return rpt
    End Function
