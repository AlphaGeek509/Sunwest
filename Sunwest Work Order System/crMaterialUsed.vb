...
Public Class crMaterialUsed
    ...
    Public Overrides Property FullResourceName() As String
        Get
            Return "Sunwest_Work_Order_System.crMaterialUsed.rpt"
        End Get
        Set
            'Do nothing
        End Set
...
Public Class CachedcrMaterialUsed
    Inherits Component
    ...
    Public Overridable Function CreateReport() As CrystalDecisions.CrystalReports.Engine.ReportDocument Implements CrystalDecisions.ReportSource.ICachedReport.CreateReport
        Dim rpt As crMaterialUsed = New crMaterialUsed
        rpt.Site = Me.Site
        Return rpt
    End Function
